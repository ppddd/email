...
import com.max.toolbox.utils.IOUtil;
...
public class MailContentActivity extends Activity {
    ...
    private void init() {
        ...
        btn_relay.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MailContentActivity.this, EditMailActivity.class).putExtra("EMAIL", email).putExtra("TYPE", 1));
            }
        });       
        btn_relay.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                startActivity(new Intent(MailContentActivity.this, EditMailActivity.class).putExtra("EMAIL", email).putExtra("type", 2));
                return true;
            }
        });
    }
